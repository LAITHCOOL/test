...
void misc::spectators_list()
{
	...
	//background
	render::get().rect_filled(width - x - 200, y - 100 + height / 2, 200, 20, Color(25, 25, 25, 255));

	//line on top
	render::get().gradient(width - x - 200, y - 100 + height / 2, 200, 2.5, Color(113, 13, 219, 255), Color(113, 13, 219, 0), GRADIENT_HORIZONTAL);

	//line on bottom
	render::get().gradient(width - x - 200, y - 80 + height / 2, 200, 2.5, Color(113, 13, 219, 0), Color(113, 13, 219, 255), GRADIENT_HORIZONTAL);

	//line on left
	render::get().gradient(width - x - 200, y - 100 + height / 2, 2.5, 20, Color(113, 13, 219, 255), Color(113, 13, 219, 0), GRADIENT_VERTICAL);

	//line on right
	render::get().gradient(width - x, y - 100 + height / 2, 2.5, 22, Color(113, 13, 219, 0), Color(113, 13, 219, 255), GRADIENT_VERTICAL);

	//text
	render::get().text(fonts[KEYBINDS], width - x - 150, y - 100 + height / 2, Color::White, HFONT_CENTERED_NONE, "Spectators");
	...
	for (auto i = 0; i < spectators.size(); i++)
	{
		...
		render::get().text(fonts[KEYBINDS1], width - x - 190, y - 62 + height / 2, Color::White, HFONT_CENTERED_NONE, spectators.at(i).c_str()); //-V106
